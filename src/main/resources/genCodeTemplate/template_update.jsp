...
<tr>
  ...
  <input type="text" class="text" id="${dataInfo.DTO_COLUMN_NAME?replace(".","")}" name="${dataInfo.DTO_COLUMN_NAME?replace("dto.","")}" notNull="false" maxLength="${(dataInfo.DATA_LENGTH / 2 )?string('#')}" value="${'$'}{${dataInfo.DTO_COLUMN_NAME}}" />
  </td>
