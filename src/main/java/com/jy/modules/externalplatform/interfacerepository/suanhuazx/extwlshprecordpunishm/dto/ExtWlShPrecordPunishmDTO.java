package com.jy.modules.externalplatform.interfacerepository.suanhuazx.extwlshprecordpunishm.dto;

import com.jy.platform.core.common.BaseDTO;
/**
 *@Description:算话人行原版(公共记录_行政处罚记录表)
 *@author Administrator
 *@version 1.0,
 *@date 2017-12-21 19:50:05
 */
public class ExtWlShPrecordPunishmDTO extends BaseDTO{
