...
/**
 * @classname: ExtWlSmPoiInfoProcesser
 * @description: 定义  数美黄页服务信息(外联平台表) 数据落地
 * @author:  Administrator
 */
@Service("com.jy.modules.externalplatform.interfacerepository.sm.extwlsmpoiinfo.service.ExtWlSmPoiInfoProcesser")
public class ExtWlSmPoiInfoProcesser implements ExtSaveMessageDao {
    ...
    @Autowired
    @Qualifier("com.jy.modules.externalplatform.interfacerepository.sm.extwlsmpoiinfo.service.ExtWlSmPoiInfoService")
    private ExtWlSmPoiInfoService service;
        ...
        try {
            ...
            if(null != map.get("result")){
                ...
                if(null != retMap.get("code") && "1100".equals(retMap.get("code").toString())){
                	isSuccess = "1";
                    ExtWlSmPoiInfoDTO dto = new ExtWlSmPoiInfoDTO();
                    ...
                    dto.setPois(retMap.get("pois").toString());//该电话号码的黄页信息 （code 为 1100时存在）
                    dto.setCreateBy(Long.parseLong("-1"));
                    
                    Long keyId = service.insertExtWlSmPoiInfo(dto);
				...
				interfaceLogDto.setRetMsg("数美黄页服务信息返回报文为空！");
            }
        }catch (Exception e) {
        	JYLoggerUtil.error(this.getClass(), "===保存数美黄页服务信息日志异常===接口日志ID:"+String.valueOf(map.get("interfaceId")), e);
    ...
    public void testSaveMethod(){
        ...
        map.put("result", "{\"code\":1100,\"message\":\"成功\",\"pois\":[\"xxxx\",\"xxxxxxx\"]}");
