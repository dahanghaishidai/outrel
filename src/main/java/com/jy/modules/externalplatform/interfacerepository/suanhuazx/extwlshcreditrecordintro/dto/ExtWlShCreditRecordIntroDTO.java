package com.jy.modules.externalplatform.interfacerepository.suanhuazx.extwlshcreditrecordintro.dto;

import com.jy.platform.core.common.BaseDTO;
/**
 *@Description:算话人行原版(信贷记录解释文字与资产相关汇总信息)
 *@author Administrator
 *@version 1.0,
 *@date 2017-12-21 19:46:39
 */
public class ExtWlShCreditRecordIntroDTO extends BaseDTO{
	...
	/**
	 *方法: 获得assetDisposal
	 *@return: java.lang.String  assetDisposal
	 */
	public String getAssetDisposal(){
		return this.assetDisposal;
	}

	/**
	 *方法: 设置assetDisposal
	 *@param: java.lang.String  assetDisposal
	 */
	public void setAssetDisposal(String assetDisposal){
		this.assetDisposal = assetDisposal;
	}

	/**
	 *方法: 获得compensate
	 *@return: java.lang.String  compensate
	 */
	...
	/**
	 *方法: 设置compensate
	 *@param: java.lang.String  compensate
	 */
