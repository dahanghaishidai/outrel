...
<script type="text/javascript">
	...
	$(function() {
		var settings = {
   			...
   			upload_url: "<app:contextPath/>/import/importTxt;jsessionid=<%=request.getSession().getId()%>",	
   			use_query_string : true,
   			file_size_limit : "100 MB",
   			file_types : "*.txt;*.rnt;",
   			file_types_description : "请选择txt或者rnt格式的文本文件",
   			file_upload_limit : 2,
   			file_queue_limit : 0,
   			custom_settings : {
...
<div id="content">
	<div class="tipCls">
		<div></div>
		<div class="tpCls"><span>模板下载：</span><a href="<app:contextPath/>/import/downloadTxt">模板.txt</a></div>
	</div>
	<div class="uploadCls">
