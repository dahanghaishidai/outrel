     ...
     <table  id="addNewsTableId" class="formTableSwap" border="0" align="center" cellpadding="0" cellspacing="1" >
		<input type="hidden" name="type" value="2" />		
  		<tr>
            <th >委托人： </th>
            <td > 
            <input id="dtootherParamsDis" type="text" name ="dtootherParamsDis" value="${consign.fromUserId }" onclick="selectUser('setCallFunFromUser')" notNull="false"  />
