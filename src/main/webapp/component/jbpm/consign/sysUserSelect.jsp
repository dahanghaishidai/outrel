...
sysuserselect.loadUserList = function (orgId){
	var v_url = contextRootPath + "/component/jbpm/consign/sysUserSelectTable.jsp?displayUserNameId=${param.displayUserNameId}&hiddenUserId=${param.hiddenUserId}&orgId=";
	if(orgId!=null) v_url += orgId;
		
	$("#contentSwap").load(v_url);
}
