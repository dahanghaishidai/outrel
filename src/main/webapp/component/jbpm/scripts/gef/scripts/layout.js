    ...
    createItemsForAccordion: function() {
        ...
        this.items = [{
            ...
            html: this.createHtml([
                {name: 'select',       image: 'select32',               title: '决策'},
                ...
                {name: 'foreach',      image: '32/gateway_exclusive',   title: 'foreach'},
                //{name: 'counter-sign', image: '32/task_empty',          title: '会签'},
                {name: 'fork',         image: '32/gateway_parallel',    title: 'fork'},
                {name: 'join',         image: '32/gateway_parallel',    title: 'join'},
                {name: 'decision',     image: '32/decision',   title: '决策'}
            ])
        }
        /*
        , {
