        ...
        var p = new Ext.form.FormPanel({
            ...
            items: [{
                ...
                listeners: {
                    'blur': function(field) {
                        var newValue = field.getValue();
                        model.procCatName = newValue;
                        //alert(model.procCatName+" cheng all-forms.js "+model.getType());
                    }
                }
                 /*
                allowBlank: false,
                ...
                listeners: {
                    'blur': function(field) {
                        ...
                        //model.dom.setElementContent('procVerName', newValue);
                    }
                }*/
                 listeners: {
                    'blur': function(field) {
    ...
    resetBasic: function(tabPanel, model) {
        var p = new Ext.form.FormPanel({
            ...
            items: [{
                ...
                fieldLabel: '任务人员指派定义',
                //xtype: 'textarea',
                value: model.dom.getElementAttribute('assignment-handler','class'),
                listeners: {
                    'blur': function(field) {
                        var newValue = field.getValue();
                        model.dom.setElementAttribute('assignment-handler','class',newValue);
                        //如果没有值 则移除该属性
                        if(newValue == '' ||newValue == null){
                        	//model.dom.removeElement('assignment-handler');
                        	model.dom.setElementContent('assignment-handler', newValue);
                        }
