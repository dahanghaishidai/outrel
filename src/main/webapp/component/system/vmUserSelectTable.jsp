...
<script type="text/javascript">
	...
	sysuserSelectTable.initFn = function(){
		...
		if(uriParam.indexOf("?")!=-1){
			uriParam=uriParam+(showLowerUser!=null?("&showLowerUser="+showLowerUser):"");
		}else{
			uriParam=(showLowerUser!=null?("?showLowerUser="+showLowerUser):"");
		}
...
<input type="hidden" id="showLowerUser" name="showLowerUser" value="${param.showLowerUser!=null?param.showLowerUser:false}"/>
