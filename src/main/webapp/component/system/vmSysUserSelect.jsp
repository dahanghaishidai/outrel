...
sysuserselect.loadUserList = function (orgId,orgType){
	var orgId=(orgId!=null?("&orgId="+orgId):"");	
	var orgType=(orgType!=null?("&orgType="+orgType):"");
	var showLowerUser=$("#showLowerUser").val();
	var showLowerUserDesc=(showLowerUser!=null?("&showLowerUser="+showLowerUser):"");
	$("#contentSwap").load(contextRootPath + "/component/system/vmUserSelectTable.jsp?a=a"+orgId+orgType+showLowerUserDesc );
}
...
sysuserselect.loadOrgTree = function (){
	...
	var treeStr={"disabledLink":false,"isEdit":false,"check":false,"checkChildNodes":false,"url":contextRootPath+'/vmtreeInfo/queryVmTreeSysOrg?orgType=',"addFun":null,"editFun":null,"removeFun":null,"viewFun":sysuserselect.loadUserListPage};
