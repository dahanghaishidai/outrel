...
sysuserselect.loadUserList = function (orgId){
	var roleParam=(orgId!=null?("&orgId="+orgId):"");
	...
	roleParam=roleParam+(roleCode!=null?("&roleCode="+roleCode):"");
	$("#contentSwap").load(contextRootPath + "/component/system/sysUserSelectTable.jsp?a=a"+roleParam+showLowerUserParam );
}
