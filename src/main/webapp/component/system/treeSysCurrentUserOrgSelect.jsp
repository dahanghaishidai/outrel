   ...
   <%@ include file="/common/StaticJspTaglib.jsp" %>
    ...
    $(document).ready(function() {
        ...
        var orgIdParam = (rootOrgId!=null&&rootOrgId!="")?("&orgId="+rootOrgId):"";
      	...
      	var trace = $("#trace").val();
        var traceParam = (trace!=null&&trace!="")?("&trace="+trace):"";
        
        var appFlag = $("#appFlag").val();
        var appFlagParam = (appFlag!=null&&appFlag!="")?("&dto.appFlag="+appFlag):"";
        
        var isVirtual = $("#isVirtual").val();
        var isVirtualParam = (isVirtual!=null&&isVirtual!="")?("&dto.isVirtual="+isVirtual):"";

        var treeStr={"disabledLink":true,"isEdit":false,"check":$("#check").val()=="true","checkChildNodes":false,
        		"url":contextRootPath+'/sysOrg/queryTreeSysOrgByCurrentUserOrg?a=a'+orgIdParam+traceParam+appFlagParam+isVirtualParam,"addFun":null,"editFun":null,"removeFun":null,"viewFun":($("#check").val()=="true")?null:selectOneOrgData};
