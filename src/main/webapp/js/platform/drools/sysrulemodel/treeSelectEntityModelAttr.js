...
jQuery(document).ready(function($) {
    ...
    var treeStr={"disabledLink":false,"isEdit":false,"check":false,"checkChildNodes":false,"url":contextRootPath+'/sysRuleModel/queryTreeSelectEntityModelAtrr',"addFun":addFun,"editFun":editFun,"removeFun":removeFun,"viewFun":viewFun};
