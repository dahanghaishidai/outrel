...
//			}
//		}
		//PL.webRoot = "http://127.0.0.1:8080/com-jy-platform-portal/";
//		var obj=window.location; 
//		var contextPath=obj.pathname.split("/")[1]; 
//		PL.webRoot=obj.protocol+"//"+obj.host+"/"+contextPath+"/";
		return PL.webRoot;
	},
...
// On response  optional callback fun is called with optional user data.
	...
	_init: function () {
		...
		PL.webRoot = MSG_PUSH_WEBROOT;//home.jsp中的全局变量MSG_PUSH_WEBROOT
		PL.pushletURL = PL.webRoot + 'pushlet.srv';
