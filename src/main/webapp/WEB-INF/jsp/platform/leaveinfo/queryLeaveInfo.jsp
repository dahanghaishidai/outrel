...
<script>
	...
	function initFn(){
		...
		//定义 table 列表信息	
			...
			//定义table 列表的表头信息
			columns : [			 
            {display : ' 员工姓名 ', code : 'userName', width : 200, align : 'center', type:'text'}
			,{display : ' 员工职级 ', code : 'userLevel', width : 200, align : 'center', type:'text'}
			,{display : ' 员工部门', code : 'orgName', width : 200, align : 'center', type:'text'}
