...
<html><head>
	...
	<script type="text/javascript" src="${basePath}/js/platform/bizauth/vmtreeinfo/updateVmtreeInfo.js"></script>
    <title>虚拟机构管理树形</title>
  ...
  <script type="text/javascript">
    ...
    $(function() {
        ...
        var treeStr={"disabledLink":false,"isEdit":true,"check":false,"checkChildNodes":false,"url":contextRootPath+'/vmtreeInfo/queryTreeVMOrgByOrgType?orgType='+orgType,"addFun":addFun,"editFun":editFun,"removeFun":removeFun,"viewFun":viewFun};
