...
<head>
  ...
  <script type="text/javascript" src="${basePath}/js/platform/bizauth/vmuservmorgmap/manageVmSysUser.js"></script>
<!-- 相关js方法 -->
...
<div class="leftPanel">
    <div class="titleSwap"><label class="innerTitle">虚拟机构树</label></div>
...
<input type="hidden" id="orgId"    name="orgId" value="${userInfo.orgId}">
