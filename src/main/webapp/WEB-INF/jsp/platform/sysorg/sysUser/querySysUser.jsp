	...
	function initFn(){
		...
		//定义 form表单查询 信息
		 var formStructure={
	        ...
	        ,{display : ' 是否有效 ', code : 'validateState', width : 200,  type:'select',value:[{"value": "", "text": "全部"},{"value": "1", "text": "有效用户"}  ,{"value": "0", "text": "无效用户"}]}
		...
		var tableStructure = {
			...
			,{display : ' 是否有效', code : 'validateStateCN', width : 60, align : 'left', type:'text', isOrder : false}
			...
			,{display : ' 性别 ', code : 'sex', width : 40, align : 'left', type:'select', isOrder : false
				,value: [{"value": "0", "text": "女"},
				         {"value": "1", "text": "男"}
				]
			}
			,{display : ' 出生日期 ', code : 'birthday', width : 80, align : 'left', type:'text', isOrder : false}
			,{display : ' 民族 ', code : 'nationality', width : 40, align : 'left', type:'select',value:<syscode:dictionary codeType="sysuser_nation" type="json"/>}
			,{display : ' 学历 ', code : 'education', width : 60, align : 'left', type:'select',value:<syscode:dictionary codeType="sysuser_education" type="json"/>}
			,{display : ' 职务 ', code : 'job', width : 80, align : 'left',type:'select',value:<syscode:dictionary codeType="sysuser_job" type="json"/>}
			,{display : ' 家庭住址 ', code : 'homeAddress', width : 100, align : 'left', type:'text', isOrder : false}
			,{display : ' 是否锁定', code : 'isLockedCN', width : 60, align : 'left', type:'text', isOrder : false}
