...
<div id="formPageSwap">
  <br/>
<form id="addNewsFormData" name="addNewsFormData" isCheck="true" action="com.jy.modules.logmonitor.sysapplogpriv.controller.SysAppLogPrivController">
 <table id="addNewsTableId" class="formTableSwap" border="0" align="center" cellpadding="0" cellspacing="1" >
<tr>
  <th> 系统标示 ：</th>
  <td > 
  <syscode:dictionary id="dtoappId" name="appId" codeType="SYSTEMFLAG" type="select" />
  </td>
  <th> 用户 ：</th>
  <td colspan="3"> 
  <input type="hidden" id="dtouserId" name="userId" value="" />
  <input type="text" class="text" id="dtousername" name="userName" notNull="false" maxLength="11" value=""  onclick="selectUser('setCallFunUserAdd')" />
  </td>
</tr>
  </table>
