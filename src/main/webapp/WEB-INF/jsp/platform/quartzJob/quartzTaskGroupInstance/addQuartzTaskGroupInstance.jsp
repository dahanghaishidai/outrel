...
<div id="formPageSwap">
  <br/>
<form id="addNewsFormData" name="addNewsFormData" isCheck="true" action="com.jy.modules.quartzJob.quartzTaskGroupInstance.controller.QuartzTaskGroupInstanceController">
