		...
		var tableStructure = {
			...
			columns : [
			 {display : ' 分组编号 ', code : 'groupId', width : 100, align : 'left', type:'fun',
			  value:function (obj){
						return "<a href='javascript:void(0)' onclick=viewData('"+obj.groupId+"')>"+obj.groupId+"</a>";
				    }	 
			 }
			,{display : ' 分组名称 ', code : 'groupName', width : 100, align : 'left', type:'text'}
			,{display : ' 是否发布', code : 'groupState', width : 100, align : 'left', type:'select',value:[
			                                                                                            {"value": "0", "text": "否"},
			                                                                                            {"value": "1", "text": "是"},
			                                                                                        ]}
			...
			,{display : ' 执行时间 ', code : 'runTime', width : 100, align : 'left', type:'text'}
			,{display : '操作', code : 'modifier', width : 200, align : 'left', type:'link',value:[
			                                                                                     {"text":"发布","action":openGroup},
			                                                                                     {"text":"取消发布","action":closeGroup}
			                                                                                     ,{"text":"立即执行","action":startGroup} ]}
		   ],
			url : "${basePath}quartzTaskGroupDef/queryListQuartzGroup",
