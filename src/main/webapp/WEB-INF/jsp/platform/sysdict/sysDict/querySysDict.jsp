	...
	function initFn(){
		//定义 form表单查询 信息
		 var formStructure={
			// 定义form表单 字段信息
			columns : [
			 {display : '数据字典名称', code : 'dictName', width : 200,  type:'text'}
	        ,{display : '数据字典编码', code : 'dictCode', width : 200,  type:'text'}
	        ,{display : '数据字典类型', code : 'dictType', width : 150,   type:'select',value:[{"value":"","text":"请选择"},{"value":"0","text":"系统级"},{"value":"1","text":"项目级"}]}
