...
<div id="formPageSwap">
  <br/>
<form:form modelAttribute="dto" name="updateNewsFormData" id ="updateNewsFormData" isCheck="true" enctype="multipart/form-data" action="com.jy.modules.platform.systemplate.controller.SysTemplateController">
...
<tr>
  <th> 模板内容 ：</th>
  <td  colspan="3"> 
  	<input type="file" class="text" id="dtotemplateContent" name="templateContent" notNull="false" maxLength="2000"/>
  	${templateContent}
  </td>
</tr>
  </table>
