...
<html><head>
	...
	<c:if test="${modelFlag=='1'}">
		<script type="text/javascript" src="${basePath}/js/platform/drools/sysrulemodel/treeSelectEntityModelAttr.js"></script>
	</c:if>
	<c:if test="${modelFlag!='1'}">
		<script type="text/javascript" src="${basePath}/js/platform/drools/sysrulemodel/treeSelectModelAttr.js"></script>
	</c:if>
