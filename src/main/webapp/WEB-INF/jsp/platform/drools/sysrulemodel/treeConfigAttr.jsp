...
<html><head>
	...
	<script type="text/javascript" src="${basePath}/js/platform/drools/sysrulemodel/treeConfigAttr.js"></script>
...
<input id="dtoId" type="hidden" value="${dto.id }" >
<div class="leftPanel">
...
<div class="contentPanel">
    <div class="titleSwap"><label class="innerTitle">属性配置</label></div>
    <div id="contentSwap" class="contentSwap">
    </div>
</div>
