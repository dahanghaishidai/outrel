...
<head>
  ...
  <title>查询角色组角色中间表</title>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <script type="text/javascript" src="${basePath}/js/platform/sysrolegrouprole/querySysRoleGroupRole.js"></script>
<!-- 相关js方法 -->
...
<!-- 列表按钮操作 start -->
	<div id="tableToolbar" class="tableToolbar" style="display:none;">
		  <shiro:hasPermission name="platform/sysrolegrouprole/querySysRoleGroupRole:add">
		  	<a href="javascript:void(0)" onclick="toAddData()" index="0">新增</a>
		  </shiro:hasPermission>
	  	 <shiro:hasPermission name="platform/sysrolegrouprole/querySysRoleGroupRole:modify">
		  	<a href="javascript:void(0)" onclick="toUpdateData()" index="1">修改</a>
		  </shiro:hasPermission>
		  <shiro:hasPermission name="platform/sysrolegrouprole/querySysRoleGroupRole:delete">
	...
	function initFn(){
		//定义 form表单查询 信息
		 var formStructure={
	        ...
	        ,{display : ' 角色组I ', code : 'roleGroupId', width : 200,  type:'text'}
		...
		var tableStructure = {
			...
			,{display : ' 角色组ID ', code : 'roleGroupId', width : 100, align : 'left', type:'text', isOrder : false}
			...
			url : "${basePath}sysRoleGroupRole/queryListSysRoleGroupRole",
