...
<script type="text/javascript">
	function initPanel() {
		$("#roleDiv").load("${basePath}sysPrvRole/prepareExecute/toQueryPage");
	}
</script>
...
<body style="background-color:#FFFFFF">
	...
	<div class="leftPanel">
		...
		<div class="contentSwap" id='roleDiv'>
			<iframe src='${basePath}sysPrvRole/prepareExecute/toQueryPage'
				id='role' frameborder="no" border="0" marginwidth="0"
				marginheight="0" scrolling="no" allowtransparency="yes" width='100%'
				onload="var fdh=(this.Document?this.Document.body.offsetHeight:this.contentDocument.body.offsetHeight);this.height=(fdh>900?fdh:900)"></iframe>
		</div>
	</div>
